...
var TempusDominusBootstrap4 = function ($) {
    ...
    var TempusDominusBootstrap4 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap4.prototype._updateMonths = function _updateMonths() {
            ...
            if (this._viewDate.locale() === 'th') {
                monthsViewHeader.eq(1).text(this._viewDate.year() + 543);
            } else {
        ...
        TempusDominusBootstrap4.prototype._updateYears = function _updateYears() {
            ...
            // l10n_th_web_buddhist_calendar FIX START !!
            if (this._viewDate.locale() === 'th') {
                yearsViewHeader.eq(1).text((startYear.year() + 543) + '-' + (endYear.year() + 543));
            } else {
            ...
            if (this._viewDate.locale() === 'th') {
                html += '<span data-action="selectYear" class="year old' + (!this._isValid(startYear, 'y') ? ' disabled' : '') + '">' + (startYear.year() - 1 + 543) + '</span>';
                while (!startYear.isAfter(endYear, 'y')) {
                    html += '<span data-action="selectYear" class="year' + (startYear.isSame(this._getLastPickedDate(), 'y') && !this.unset ? ' active' : '') + (!this._isValid(startYear, 'y') ? ' disabled' : '') + '">' + (startYear.year() + 543) + '</span>';
                    startYear.add(1, 'y');
                }
                html += '<span data-action="selectYear" class="year old' + (!this._isValid(startYear, 'y') ? ' disabled' : '') + '">' + (startYear.year() + 543) + '</span>';
            } else {
            ...
            // l10n_th_web_buddhist_calendar FIX STOP !!
        ...
        TempusDominusBootstrap4.prototype._updateDecades = function _updateDecades() {
            ...
            // l10n_th_web_buddhist_calendar FIX START !!
            // TODO make decade options for th
            if (this._viewDate.locale() === 'th') {
               decadesViewHeader.eq(1).text((startDecade.year() + 543) + '-' + (endDecade.year() + 543));
            } else {
            ...
            while (!startDecade.isAfter(endDecade, 'y')) {
                ...
                if (this._viewDate.locale() === 'th') {
                    html += '<span data-action="selectDecade" class="decade' + (this._getLastPickedDate().isAfter(startDecade) && this._getLastPickedDate().year() <= endDecadeYear ? ' active' : '') + (!this._isValid(startDecade, 'y') && !minDateDecade && !maxDateDecade ? ' disabled' : '') + '" data-selection="' + (startDecade.year() + 6) + '">' + (startDecade.year() + 543) + '</span>';
                } else {
            ...
            if (this._viewDate.locale() === 'th') {
                html += '<span data-action="selectDecade" class="decade old" data-selection="' + (startDecade.year() + 6) + '">' + (startDecade.year() + 543)  + '</span>';
            } else {
        ...
        TempusDominusBootstrap4.prototype._fillDate = function _fillDate() {
            ...
            // l10n_th_web_buddhist_calendar FIX START !!
            if (this._viewDate.locale() === 'th') {
                daysViewHeader.eq(1).text(this._viewDate.clone().add(543, 'Y').format(this._options.dayViewHeaderFormat));
            } else {

...
(function (factory) {
    ...
    $.Widget.prototype = {
        ...
        _setOptionDisabled: function (value) {
            this._toggleClass(this.widget(), this.widgetFullName + "-disabled", null, Boolean(value));
            ...
            flip: {
                left: function (position, data) {
                    ...
                    if (overLeft < 0) {
                        ...
                        newOverLeft =
                            position.left - data.collisionPosition.marginLeft + myOffset + atOffset + offset - offsetLeft;
    ...
    // This file is deprecated
    var ie = ($.ui.ie = Boolean(/msie [\w.]+/.exec(navigator.userAgent.toLowerCase())));
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _getHandle: function (event) {
            return this.options.handle ? Boolean($(event.target).closest(this.element.find(this.options.handle)).length) : true;
        },
...
*/
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        refresh: function () {
            ...
            this._toggleClass("ui-menu-icons", null, Boolean(this.element.find(".ui-icon").length));
        ...
        _setOptionDisabled: function (value) {
            ...
            this._toggleClass(null, "ui-state-disabled", Boolean(value));
        },
   ...
   allowing multiple different settings on the same page. */
    ...
    $.extend(Datepicker.prototype, {
                ...
                var handler = {
                    ...
                    selectDay: function () {
                        $.datepicker._selectDay(
                            id,
                            Number(this.getAttribute("data-month")),
                            Number(this.getAttribute("data-year")),
                            this
                        );
                        return false;
                    },
        ...
        _generateMonthYearHeader: function (
            ...
            // L10n_th_web_calender_be start
            var locale = this._get(inst, "locale");
            // Year selection
            if (!inst.yearshtml) {
                inst.yearshtml = "";
                if (secondary || !changeYear) {
                    locale = this._get(inst, "locale");
                    if (locale === "th-TH") {
                    ...
                    for (; year <= endYear; year++) {
                        // l10n_th_web_buddhist_calendar start
                        if (locale === "th-TH") {
                            inst.yearshtml +=
                                "<option value='" +
                                year +
                        ...
                        // l10n_th_web_buddhist_calendar end
                    }
    ...
    (function () {
        if ($.expr && $.expr.filters && $.expr.filters.animated) {
            $.expr.filters.animated = (function (orig) {
                return function (elem) {
                    return Boolean($(elem).data(dataSpaceAnimated)) || orig(elem);
                };
        ...
        $.fn.extend({
            ...
            cssClip: function (clipObj) {
                if (clipObj) {
                    return this.css(
                        "clip",
                        "rect(" + clipObj.top + "px " + clipObj.right + "px " + clipObj.bottom + "px " + clipObj.left + "px)"
                    );
                }

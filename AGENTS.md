...
- Keep AGENTS.md and CLAUDE.md semantically consistent. AGENTS.md is the canonical source for repo-wide agent guidance.
  Agent-specific instruction files may differ in formatting or examples but must not contradict this contract.

...
class Timing(models.Model):
    ...
    timing_tmpl_id = fields.Many2one(
    ...
    @api.onchange("timing_tmpl_id")
    def _onchange_template(self):
        if self.timing_tmpl_id:
            self.update(
                {
                    "frequency": self.timing_tmpl_id.frequency,
                    "frequency_max": self.timing_tmpl_id.frequency_max,
                    "duration": self.timing_tmpl_id.duration,
                    "duration_max": self.timing_tmpl_id.duration_max,
                    "duration_unit": self.timing_tmpl_id.duration_unit,
                    "period": self.timing_tmpl_id.period,
                    "period_max": self.timing_tmpl_id.period_max,
                    "period_unit": self.timing_tmpl_id.period_unit,
                    "when": [(6, 0, self.timing_tmpl_id.when.ids)],
                    "day_of_week": [(6, 0, self.timing_tmpl_id.day_of_week.ids)],
                    "offset": self.timing_tmpl_id.offset,
                    "time_of_day": [(6, 0, self.timing_tmpl_id.time_of_day.ids)],
                    "name": self.timing_tmpl_id.name,
                }
            )
